...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { description: @interview.description, interviewcategory_id: @interview.interviewcategory_id, title: @interview.title, user_id: @interview.user_id } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { description: @interview.description, interviewcategory_id: @interview.interviewcategory_id, title: @interview.title, user_id: @interview.user_id } }
